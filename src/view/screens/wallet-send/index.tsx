...
const mapDispatchToProps = (dispatch: any) => {
  return {
    attemptSend: (payload: any, componentId: string) => dispatch(sendAttempt(payload, componentId))
  }
};

const walletContainer = connect(mapStateToProps, mapDispatchToProps)(Component);
